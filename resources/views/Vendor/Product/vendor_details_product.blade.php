        ...
        <div class="container-fluid">
            <div class="pl-5 pr-5 pt-3">
                ...
                <div class="text-center">
                    <a href="{{route('vendor-edit-product',['id' => $product->id])}}" class="btn btn-sm btn-outline-warning" style="border-radius: 18px;"><i class="fas fa-edit"></i></a>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        @endif
                        <h6>
                            Total Quantity: <strong>{{$product->product_quantity}}</strong>
                        ...
                        <h6>Price: <strong>{{$product->product_price}}</strong></h6>
                        @if($product->type)
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="tz-gallery">
                            ...
                            <div class="row">
                                ...
                                <!-- -------------------------------------- -->
                                @foreach($pro_image as $v_img)
                                    <div class="col-sm-6 col-md-4">
                                        <a class="lightbox" href="">

                                            <img src="{{asset($v_img->product_image)}}" >
                                        ...
                                        <div class="text-center">
                                            ...
                                            <a href="#" id="{{$v_img->id}}" class="fas fa-trash"
                                               onclick="event.preventDefault();
                                                   var check = confirm('Are you sure you want to delete?');
                                                   if(check){
                                                   document.getElementById('deleteImageForm'+'{{$v_img->id}}').submit();
                                                   }"
                                            >Delete</a>
                                            <form id="deleteImageForm{{$v_img->id}}" action="{{route('vendor-delete-more-image')}}" method="post">
                                                @csrf
                                                <input type="hidden" name="id" value="{{$v_img->id}}">
                                            </form>
    ...
    <div class="modal fade" id="addImageModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="form-group" action="{{route('vendor-add-more-image')}}" method="POST" enctype="multipart/form-data">
                    @csrf
    ...
    <div class="modal fade" id="addSizeColor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-group" action="{{route('vendor-save-sizecolor')}}" method="POST">
                        @csrf
                        <input type="hidden" name="product_id" value="{{$product->id}}">
                        <div class="form-row">
                            Size <br>
