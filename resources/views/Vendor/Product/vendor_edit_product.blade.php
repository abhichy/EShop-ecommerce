    ...
    <div id="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <form class="form-group" action="{{route('vendor-update-product')}}" method="POST" enctype="multipart/form-data" name="editProductForm">
                        @csrf
                        <div class="form-row">
                            <div class="col">
                                <label for="product_name">Product Name</label>
                                <input required type="text" class="form-control" value="{{$product->product_name}}" name="product_name" id="product_name"/>
                            ...
                            <div class="col">
                                ...
                                <textarea required type="text" class="form-control" name="product_specification" id="product_description">{{$product->product_specification}}</textarea>
                                <small class="text-danger"></small>
                            </div>--}}
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col">
                                ...
                                <textarea required type="text" class="form-control" name="product_specification" id="product-spec">{{$product->product_specification}}</textarea>
                                <small class="text-danger"></small>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-3">
                                ...
                                <input required type="text" class="form-control form-control-sm" id="pr" value="{{$product->product_price}}" name="product_price" />
                                <small class="text-danger"></small>
                            </div>
                            <div class="col-md-3">
                                ...
                                <input required type="text" class="form-control form-control-sm" value="BDT" id="cur" value="{{$product->currency}}" name="currency" />
