...
<head>
    ...
    <link rel="stylesheet" href="{{asset('/')}}public/client/assets/vendor/css/font-awesome.min.css">
    ...
    <script src="{{asset('public/client/assets/js/custom/search.js')}}"></script>
...
-->
    ...
    <link href="{{asset('/')}}public/client/assets/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link href="{{asset('/')}}public/client/assets/rating.css" rel="stylesheet">
...
<script src="{{asset('/')}}public/client/assets/rating.js"></script>
<script src="{{asset('public/client/assets/js/bootstrap.min.js')}}"></script>
<script src="{{asset('public/client/assets/js/jquery.magnific-popup.min.js')}}"></script>
<script src="{{asset('public/client/assets/js/owl.carousel.min.js')}}"></script>
<script src="{{asset('public/client/assets/js/script.js')}}"></script>
