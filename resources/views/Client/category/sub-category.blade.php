    ...
    <section class="shop shop-1 sub-cat">
        <div class="container-fluid page-bgc">
            <div class="row">
                        ...
                        <div id="sidebar-main" class="sidebar sidebar-default sidebar-separate sidebar-fixed">
                            ...
                            <div class="range-box mb-2">
                                ...
                                <div class="d-flex my-4">
                                    <div class="w-75">
                                    <input type="range" class="custom-range" id="productPrice" min="0" max="10000">
                                    </div>
                ...
                <div class="col-9" id="productData">
                    <div class="col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="shop-box-title">
                                <div class="row">
                                    <div class="col-sm-3">
                                        <a href="{{route('product',['id'=>$product->id,'category_id'=>$product->category_id])}}"><h4 style="color: black">{{$product->product_name}}</h4></a>
                                    </div>
                                    <div class="col-sm-3">
