...
@section('admin-home')
                            ...
                            <table class="table table-bordered" style="border-style: dashed" width="100%"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" size="2" id="discount-{{$i}}" onchange="discount(this.value,{{$i}})" class="form-control input-sm Discounts" name="discount[]"
                                                id="inputEmail4" /></td>
                                        <td>
                            ...
                            <table class="table table-bordered" style="border-style: dashed" width="100%"
                                ...
                                <thead class="">
                                    ...
                                    <tr>
                                        ...
                                        <td> <input type="number" id="finalDiscount" onkeyup="Finaldiscount()" class="form-control input-sm" name="final_discount" id="inputEmail4">
                                        </td>
                                    </tr>
                                    <tr>
    ...
    <script src="{{ asset('public/admin/js/sales.js') }}"></script>
@endsection
