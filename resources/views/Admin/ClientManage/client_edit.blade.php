                ...
                <div class="card-body">
                    <form action="{{ route('registration-update') }}" method="post">
                        ...
                        <div class="form-group row align-items-center">
                            <div class="col mt-4">
                                <input name="full_name" type="text" value="{{$client->full_name}}" class="form-control" placeholder="Full Name">
                        ...
                        <div class="form-group row align-items-center mt-4">
                            <div class="col">
                                <input type="email" value="{{$client->email }}" name="email" class="form-control" placeholder="Email">
                        ...
                        <div class="form-group row align-items-center mt-4">
                            <div class="col">
                                <input type="password" value="{{$client->password }}" name="password" class="form-control" placeholder="Password">
                                <span
                        ...
                        <div class="form-group row align-items-center mt-4">
                            <div class="col">
                                <input type="text" value="{{$client->contact_no }}" name="contact_no" class="form-control" placeholder="Contact No">
                                <span
