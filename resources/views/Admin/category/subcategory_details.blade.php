...
<div class="pl-5 pr-5 pt-3">
  ...
  {{--<a href="{{route('edit-subcategory',['id' => $category->id ])}}" class="btn btn-sm btn-outline-warning" style="border-radius: 18px;">{{$category->category_name}}<i class="fas fa-edit"></i></a>--}}
  ...
  <div class="row">
      <div class="col-md-6 offset-md-3">
          <!-- List of Categories -->
      <img class="mx-auto d-block" width="50%" src="{{asset($category->category_image)}}" alt="">
